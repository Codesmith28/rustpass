use rustpass::encryption::{decrypt::{decode_codesmith28, fibbil_unhash}, encrypt::{codesmith28, fibbil_hash}};
...
fn test_fibbil_encryption_decryption() {
    ...
    for original in test_cases {
        ...
        assert_eq!(decrypted, original, "Fibbil encryption/decryption failed for: {}", original);
    }
}
...
fn test_codesmith28_encryption_decryption() {
    ...
    for original in test_cases {
        ...
        assert_eq!(decrypted, original, "Codesmith28 encryption/decryption failed for: {}", original);
    }
}
